![Regular Impressions](assets/logo.png)
...
Given enough free time, I plan to write more features for Regular Impressions, such as to:

- [ ] Support different types of regular expression flavors
- [ ] Expand the features to allow regular expression to regular impression conversion
- [ ] Rewrite the codebase using a JavaScript framework
